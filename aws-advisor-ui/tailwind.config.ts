  ...
  theme: {
    extend: {
      colors: {
        ...
        // Amber opacity ladder for semantic states (documented in
        // ConfidenceDot.tsx): 1.0 active · 0.7 pipeline nodes · 0.6 focus ·
        // 0.4 hover/badges · 0.3 input focus · 0.2 section rules ·
        // 0.35 dimmed state · 0.15 faintest accent.
