...
import { AMBER_CONFIDENCE_OPACITY } from "./ConfidenceDot";
...
// Opacity per segment when filled — uses the canonical amber confidence
// scale shared with ConfidenceDot (low/med/high), never a different hue.
const FILLED_OPACITY = [
  AMBER_CONFIDENCE_OPACITY.low,
  AMBER_CONFIDENCE_OPACITY.medium,
  AMBER_CONFIDENCE_OPACITY.high,
];
