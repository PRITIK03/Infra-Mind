...
export function AwaitingInputPanel({ question, onAnswer, disabled }: Props) {
  ...
  return (
    <div className="animate-slide-in">
      ...
      {/* Answer input */}
      <form onSubmit={handleSubmit} className="group flex gap-0">
        <div className="flex items-center border border-border-subtle bg-transparent px-3 text-amber font-mono text-sm shrink-0 transition-colors duration-150 group-focus-within:border-amber/30">
          &gt;
        </div>
        <input
          ref={inputRef}
          ...
          className={[
            ...
            "transition-colors duration-150 group-focus-within:border-amber/30",
        ...
        <button
          ...
          className={[
            ...
            "group-focus-within:border-amber/30",
